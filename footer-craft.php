			...
			<div class="row">
				<div class="span main">
					...
					<div class="span subscribe">
						<a href="https://readerservices.makezine.com/mk/subscribe.aspx?PC=MK&PK=M**NEWB"><img src="http://makezine.com/images/footer/current-volume-footer.gif" alt="MAKE Magazine Cover" width="115" height="163" id="mag-cover">
