<?php
/**
 * Template Name: Arduino san content
 */
...
<style type="text/css">
#arduino-header { background:#ee1c24 url('http://cdn.makezine.com/make/arduino/Make-Arduino_banner_tag_600x100.gif') no-repeat 5% 50%; color:#fff; font-weight:bold; text-align:right; height:100px; padding: 0px 10px;}
#arduino-feature-wrap { padding:10px; background-color:#dfdfdf;}
#arduino-feature-wrap h1 { text-transform:uppercase; font-size:14px;}
.arduino-feat-thumb { width:185px; float:left;padding-right:20px;}
...
.entry-title { margin-bottom: 0.5em; font-size:18px; line-height:24px; }
...
.arduino-section-head h1 { text-decoration:none; text-transform:uppercase; font-size:14px; padding:0px; margin:0px; color:#fff;}
.arduino-section-wrap { }
.arduino-section-left { margin-right:20px; }
.arduino-section-left, .arduino-section-right { width:275px; float:left; }
.arduino-section-left h4, .arduino-section-right h4 { margin-top:0px; }
.arduino-section-thumb { width:170px; float:left;padding-right:20px;}
