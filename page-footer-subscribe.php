					...
					<div class="row">
						<div class="span main">
									...
									<fieldset>
										...
										<label class="control-label" for="optionsCheckbox">Sign up to receive exclusive content and offers.</label>
											<div class="controls">
												...
												<input type="checkbox" name="cm-ol-jjhuukr" id="MAKEMarketWirenewsletter" /> Maker Pro Newsletter
												</label> 
											<!-- END controls -->
											</div>
										<!-- control-group -->
							...
							<div class="span subscribe">
								<img src="https://s2.wp.com/wp-content/themes/vip/makeblog/img/arrow-footer.png" width="95" height="46" id="mag-arrow">
								<a href="https://readerservices.makezine.com/mk/subscribe.aspx?PC=MK&PK=M**NEWB"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/footer-make-cover.jpg" alt="MAKE Magazine Cover" width="115" height="163" id="mag-cover"></a>
